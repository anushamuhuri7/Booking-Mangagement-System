...
<form action="{{Request::segment(2)=='add'?route('webpage.save'):route('webpage.update',['id'=>Request::segment(2)])}}" method="POST">
  ...
  <div class="container">
    <div class="mb-3 w-50">
      ...
      <input type="text" class="form-control" id="page_name" name="page_name" placeholder="Page Name" value="{{isset($data->name)?$data->name:''}}">
  </div>
      <div class="mb-3 w-50">
      ...
      <div class="mb-3 w-50">
          ...
          <textarea id="pagecontent" name="page_content" class="form-control" rows="10">{{isset($data->html)?$data->html:''}}</textarea>
      </div>
      <div class="mb-3 w-50">
